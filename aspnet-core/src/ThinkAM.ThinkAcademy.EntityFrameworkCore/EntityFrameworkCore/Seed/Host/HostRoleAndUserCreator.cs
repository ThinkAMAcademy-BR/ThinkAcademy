...
namespace ThinkAM.ThinkAcademy.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly ThinkAcademyDbContext _context;

        public HostRoleAndUserCreator(ThinkAcademyDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new ThinkAcademyAuthorizationProvider())
