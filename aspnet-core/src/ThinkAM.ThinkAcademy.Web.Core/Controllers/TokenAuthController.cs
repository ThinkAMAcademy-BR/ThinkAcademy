...
using Abp.UI;
using ThinkAM.ThinkAcademy.Authentication.External;
...
using ThinkAM.ThinkAcademy.Models.TokenAuth;
using ThinkAM.ThinkAcademy.MultiTenancy;

namespace ThinkAM.ThinkAcademy.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : ThinkAcademyControllerBase
    {
